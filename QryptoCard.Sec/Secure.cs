...
namespace QryptoCard.Sec
{
    public class Secure
    {
        ...
        public static string EncryptAPP(string data)
        {
            ...
            byte[] pwdBytes = Encoding.UTF8.GetBytes(APPKey);
        ...
        public static string DecryptAPP(string data)
        {
            RijndaelManaged rijndaelCipher = new RijndaelManaged();
        ...
        public static string EncryptDB(string data)
        {
            ...
            rijndaelCipher.KeySize = 0x80;
            rijndaelCipher.BlockSize = 0x80;
            byte[] pwdBytes = Encoding.UTF8.GetBytes(DBKey);
            byte[] keyBytes = new byte[0x10];
            int len = pwdBytes.Length;
        ...
        public static string DBtoAPP(string text)
        {
            text = DecryptDB(text);
            return EncryptAPP(text);
        }

        public static string APPtoDB(string text)
        {
            text = DecryptAPP(text);
            return EncryptDB(text);
        }
    }
}

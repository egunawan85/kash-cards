...
applies during the dev shakeout / launch** as an idempotent, run-once migration in
`deploy/sql/migrations/` (same additive pattern as `0001-token-tables.sql`). Expected
deltas, all additive, no backfill:

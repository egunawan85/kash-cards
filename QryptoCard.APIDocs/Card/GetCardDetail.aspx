<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="GetCardDetail.aspx.cs" Inherits="QryptoCard.APIDocs.Card.GetCardDetail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    ...
    <div class="page-title d-flex flex-column me-3">
        <!--begin::Title-->
        <h1 class="d-flex text-gray-900 fw-bold my-1 fs-3">Get Card Detail</h1>
        <!--end::Title-->
        <!--begin::Breadcrumb-->
        <ul class="breadcrumb breadcrumb-dot fw-semibold text-gray-600 fs-7 my-1">
            ...
            <!--end::Item-->
            <!--begin::Item-->
            <li class="breadcrumb-item text-gray-800">https://api-dev.kash.cards/v1/card/detail</li>
            <!--end::Item-->
        </ul>
        <!--end::Breadcrumb-->
    </div>
            ...
            <div class="card h-md-100">
                ...
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        ...
                        <span class="text-active-dark mt-1 fw-semibold fs-6">This API used to get card detail by ID.</span>
                    </h3>
                    <!--begin::Toolbar-->

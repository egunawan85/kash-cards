<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CancelDepositCard.aspx.cs" Inherits="QryptoCard.APIDocs.Transaction.CancelDepositCard" %>

<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    <!--begin::Page title-->
    <div class="page-title d-flex flex-column me-3">
        <!--begin::Title-->
        <h1 class="d-flex text-gray-900 fw-bold my-1 fs-3">Cancel Deposit Card</h1>
        <!--end::Title-->
        <!--begin::Breadcrumb-->
        <ul class="breadcrumb breadcrumb-dot fw-semibold text-gray-600 fs-7 my-1">
            <!--begin::Item-->
            <li class="breadcrumb-item text-gray-600"><span class="badge badge-danger badge-sm">DEL</span></li>
            <!--end::Item-->
            <!--begin::Item-->
            ...
            <div class="card h-md-100">
                ...
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        ...
                        <span class="text-active-dark mt-1 fw-semibold fs-6">This API used to cancel card deposit. This API only work for status = created.</span>
                    </h3>
                    <!--begin::Toolbar-->

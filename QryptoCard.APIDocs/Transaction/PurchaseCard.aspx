<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PurchaseCard.aspx.cs" Inherits="QryptoCard.APIDocs.Transaction.PurchaseCard" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    ...
    <div class="page-title d-flex flex-column me-3">
        <!--begin::Title-->
        <h1 class="d-flex text-gray-900 fw-bold my-1 fs-3">Purchase Card</h1>
        <!--end::Title-->
        <!--begin::Breadcrumb-->
            ...
            <div class="card h-md-100">
                ...
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        ...
                        <span class="text-active-dark mt-1 fw-semibold fs-6">This API used to purchase card.</span>
                    </h3>
                    <!--begin::Toolbar-->

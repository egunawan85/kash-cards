<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="GetCardDepositList.aspx.cs" Inherits="QryptoCard.APIDocs.Transaction.GetCardDepositList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    <!--begin::Page title-->
    <div class="page-title d-flex flex-column me-3">
        <!--begin::Title-->
        <h1 class="d-flex text-gray-900 fw-bold my-1 fs-3">Get Card Deposit List</h1>
        <!--end::Title-->
        <!--begin::Breadcrumb-->
        <ul class="breadcrumb breadcrumb-dot fw-semibold text-gray-600 fs-7 my-1">
            ...
            <!--end::Item-->
            <!--begin::Item-->
            <li class="breadcrumb-item text-gray-800">https://api-dev.kash.cards/v1/transaction/card/deposit/list</li>
            <!--end::Item-->
        </ul>
        <!--end::Breadcrumb-->
    </div>
            ...
            <div class="card h-md-100">
                ...
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        ...
                        <span class="text-active-dark mt-1 fw-semibold fs-6">This API used to get all transaction of card's deposit.</span>
                    </h3>
                    <!--begin::Toolbar-->
                        ...
                        <div class="card card-dashed mb-4">
                            ...
                            <div id="kt_docs_card_collapsible1" class="collapse show">
                                <div class="card-body">
                                    ...
                                    <span class="text-active-dark mt-1 fw-semibold fs-6">Data</span>&nbsp;&nbsp;<span class="text-gray-500 mt-1 fw-semibold fs-6">array of objects</span>&nbsp;&nbsp;<span class="text-danger mt-1 fs-6">required</span>
                                    <br />
                                    <div class="card card-dashed mt-4 mb-4">
                                        <div id="kt_docs_card_collapsible2" class="collapse show">
                                            <div class="card-body">
                                                ...
                                                <br />
                                                <span class="text-active-dark mt-1 fs-7">Deposit amount</span>
                                                <br />
                                                <hr />
                                                ...
                                                <br />
                                                <hr />
                                                <span class="text-active-dark mt-1 fw-semibold fs-6">ReceivedAmount</span>&nbsp;&nbsp;<span class="text-gray-500 mt-1 fw-semibold fs-6">double</span>&nbsp;&nbsp;<span class="text-danger mt-1 fs-6">required</span>
                                                <br />
                                                <span class="text-active-dark mt-1 fs-7">Received amount of the card</span>
                                                <br />
                                                <hr />
                                                <span class="text-active-dark mt-1 fw-semibold fs-6">Remark</span>&nbsp;&nbsp;<span class="text-gray-500 mt-1 fw-semibold fs-6">string</span>&nbsp;&nbsp;<span class="text-danger mt-1 fs-6">required</span>
                                                <br />
                                                <span class="text-active-dark mt-1 fs-7">remark</span>
                                                <br />
                                                <hr />
                                                <div class="row">
                                                    <div class="col-lg-9">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-3  text-end">
                                                        <select class="form-select" aria-label="Select example">
                                                            ...
                                                            <option value="2">paid = the transaction is paid and waiting for deposit the card</option>
                                                            <option value="2">in progress = the deposit still in progress</option>
                                                            <option value="2">success = the deposit is complete</option>
                                                ...
                                                <span class="text-active-dark mt-1 fw-semibold fs-6">DateTransaction</span>&nbsp;&nbsp;<span class="text-gray-500 mt-1 fw-semibold fs-6">datetime</span>&nbsp;&nbsp;<span class="text-danger mt-1 fs-6">required</span>
                                                <br />
                                                <span class="text-active-dark mt-1 fs-7">Transaction date of the transaction (yyyy-MM-dd hh:mm:ss.fff)</span>
                                                <br />
                                                <hr />
                                                ...
                                                <br />
                                                <hr />
                                                <span class="text-active-dark mt-1 fw-semibold fs-6">DateReceived</span>&nbsp;&nbsp;<span class="text-gray-500 mt-1 fw-semibold fs-6">datetime</span>&nbsp;&nbsp;<span class="text-danger mt-1 fs-6">required</span>
                                                <br />
                                                <span class="text-active-dark mt-1 fs-7">Received date of the transaction (yyyy-MM-dd hh:mm:ss.fff)</span>
                                                <br />
                                                <hr />

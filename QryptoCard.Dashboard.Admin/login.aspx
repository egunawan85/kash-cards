<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="QryptoCard.Dashboard.Admin.login" %>
                    ...
                    <div class="d-flex flex-center flex-column flex-column-fluid px-lg-10 pb-15 pb-lg-20">
                        ...
                        <form runat="server" class="form w-100">
                            ...
                            <div class="d-grid mb-10">
                                <asp:Button runat="server" id="btnLogin" OnClick="btnLogin_ServerClick" class="btn btn-primary" Text="Sign In" OnClientClick="this.disabled=true;" UseSubmitBehavior="false" >
                            ...
                            <%--<div class="text-gray-500 text-center fw-semibold fs-6">
                                ...
                                <a href="register.aspx" class="link-primary">Sign up</a>
                            </div>--%>
                            <!--end::Sign up-->
                        </form>
                        <!--end::Form-->

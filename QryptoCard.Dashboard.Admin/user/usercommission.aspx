<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="usercommission.aspx.cs" Inherits="QryptoCard.Dashboard.Admin.user.usercommission" %>
            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bold fs-3 mb-1">Commission List</span>
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="No." ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" HeaderStyle-Width="50px">
                                    <ItemTemplate>
                                        ...
                                        <asp:HiddenField runat="server" ID="hfUID" Value='<%# Eval("UserID") %>' />
                                        <asp:HiddenField runat="server" ID="hfCommission" Value='<%# Eval("Commission") %>' />
                                ...
                                <asp:BoundField DataField="Param1" HeaderText="Commission" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" HeaderStyle-Width="100px" />
                                        ...
                                        <div class="card-toolbar justify-content-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px" data-kt-menu="true">
                                                ...
                                                <div class="menu-item px-3" runat="server">
                                                    <button runat="server" id="btnUpdateComm" onserverclick="btnUpdateComm_ServerClick" class="btn btn-active-light-warning btn-sm px-3 text-start" style="width: 100%">Update Commission</button>
                                                </div>
                                                <div class="separator mt-3 opacity-75"></div>
                                            </div>
                                        </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ModalContent" runat="server">
    ...
    <div class="modal fade" tabindex="-1" id="myModalUpdateComm" aria-hidden="true" data-backdrop="static">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title">Update Commissiom Rate</h3>
                ...
                <div class="modal-body">
                    <div class="alert alert-dismissible bg-light-danger d-flex flex-column flex-sm-row p-5 mb-10" runat="server" id="divfailedcomm" visible="false">
                        <i class="ki-duotone ki-notification-bing fs-2hx text-danger me-4 mb-5 mb-sm-0"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i>
                        <div class="d-flex flex-column pe-0 pe-sm-10">
                            <h4 class="fw-semibold">Failed</h4>
                            <span>
                                <asp:Label runat="server" ID="lblFailedComm" Text="Error message" /></span>
                        </div>
                        <button type="button" class="position-absolute position-sm-relative m-2 m-sm-0 top-0 end-0 btn btn-icon ms-sm-auto" runat="server" id="btndfailedcomm" onserverclick="btndfailedcomm_ServerClick">
                            <i class="ki-duotone ki-cross fs-1 text-danger"><span class="path1"></span><span class="path2"></span></i>
                        </button>
                    </div>
                    ...
                    <div class="input-group">
                        <asp:TextBox runat="server" ID="txtUserIDUpdate" Enabled="false" CssClass="form-control" />
                    </div>
                    <br />
                    <label class="form-label">Email </label>
                    <div class="input-group">
                        <asp:TextBox runat="server" ID="txtEmailUpdate" Enabled="false" CssClass="form-control" />
                    </div>
                    <br />
                    <label class="form-label">Current Commission (in %) </label>
                    <div class="input-group">
                        <asp:TextBox runat="server" ID="txtCurrentFee" Enabled="false" CssClass="form-control" />
                    </div>
                    <br />
                    <label class="form-label">New Commission (in %) </label>
                    <div class="input-group">
                ...
                <div class="modal-footer">
                    <button class="btn btn-danger" type="button" data-bs-dismiss="modal">Close</button>
                    <asp:Button CssClass="btn btn-success" runat="server" ID="btnUpdateCommExec" Text="Update" OnClick="btnUpdateCommExec_Click" />
                </div>
            </div>
        </div>
    </div>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ScriptContent" runat="server">
    <script type="text/javascript">
        ...
        $(window).load(function () {
            $('#myModalUpdateComm').modal({ backdrop: 'static', keyboard: false });
            if (window.isModalComm) {
                $('#myModalUpdateComm').modal('show');
            }
            else {
                $('#myModalUpdateComm').modal('hide');
            }
            console.log(window.isModalComm);
            console.log('this is another debugging message');
        });

<%@ Page Title="Administrator" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="admin.aspx.cs" Inherits="QryptoCard.Dashboard.Admin.setting.admin" %>
    ...
    <div class="card mb-5 mb-xl-8">
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bold fs-3 mb-1">Admin List</span>
        ...
        <div class="card-body py-3">
            ...
            <div class="row" style="margin-bottom: 10px">
                <div class="col-md-2 col-sm-3 col-xs-12" visible="true">
                    <div class="row mb-4" runat="server">
                        ...
                        <div class="input-group">
                            <asp:DropDownList runat="server" ID="ddlRole" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlRole_SelectedIndexChanged">
                                <asp:ListItem Text="All Role" Value="all"></asp:ListItem>
            ...
            <div class="table-responsive">
                ...
                <asp:GridView CssClass="table table-striped gy-5 gs-7" ID="gvListItem" HeaderStyle-CssClass="header-table" runat="server" AutoGenerateColumns="false" DataKeyNames="AdminID" AllowPaging="True" PageSize="50" AllowCustomPaging="False" OnPageIndexChanging="gvListItem_PageIndexChanging" OnRowCreated="gvListItem_RowCreated">
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="No." ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" HeaderStyle-Width="50px">
                            <ItemTemplate>
                                <asp:HiddenField runat="server" ID="hfID" Value='<%# Eval("AdminID") %>' />
                                <%--<asp:HiddenField runat="server" ID="hfURL" Value='<%# Eval("URL") %>' />--%>
                                <%# Container.DataItemIndex + 1 %>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField DataField="FirstName" HeaderText="Fullname" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" HeaderStyle-Width="100px" />
                        ...
                        <asp:BoundField DataField="Phone" HeaderText="Phone" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" HeaderStyle-Width="100px" />
                        <asp:BoundField DataField="Role" HeaderText="Role" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" HeaderStyle-Width="100px" />
                        <asp:TemplateField HeaderText="Status" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" HeaderStyle-Width="100px">
                            <ItemTemplate>
                                <center>
                                    <span class="badge badge-light-success" runat="server" visible='<%# IsVerified((int)Eval("isVerified")) %>'>verified</span>
                                    <span class="badge badge-light-danger" runat="server" visible='<%# !IsVerified((int)Eval("isVerified")) %>'>not verified yet</span>
                                </center>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <%--<asp:TemplateField HeaderText="Action" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" HeaderStyle-Width="150px">
                            <ItemTemplate>
                                <div class="input-group flex-center">
                                    <button class="btn btn-icon btn-primary btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="More detail" runat="server" id="btnInfo" onserverclick="btnInfo_ServerClick"><i class="fas fa-info fs-4"></i></button>
                                    <button class="btn btn-icon btn-danger btn-sm" visible='<%# IsOwner((string)Eval("Email")) %>' data-bs-toggle="tooltip" data-bs-placement="top" title="Ban User" runat="server" id="btnCancel" onserverclick="btnCancel_ServerClick"><i class="fas fa-ban fs-4"></i></button>
                                </div>
                            </ItemTemplate>
                        </asp:TemplateField>--%>
                        <asp:BoundField DataField="DateJoin" HeaderText="Joined Date" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" HeaderStyle-Width="100px" />
                        <asp:BoundField DataField="InvitedByFirstName" HeaderText="Invited By" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" HeaderStyle-Width="100px" />
                                ...
                                <div class="card-toolbar justify-content-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px" data-kt-menu="true">
                                        ...
                                        <div class="menu-item px-3" runat="server" visible='<%# IsOwner((string)Eval("Email")) %>'>
                                            <button runat="server" id="btnCancel" onserverclick="btnCancel_ServerClick" class="btn btn-active-light-danger btn-sm px-3 text-start" style="width: 100%">Ban User</button>
                                        </div>
                                        <div class="separator mt-3 opacity-75"></div>
                                    </div>
                                </div>
            ...
            <div class="align-content-center" style="margin-bottom: 20px" runat="server" id="divnorow">
                <center>
                    <asp:Label runat="server" ID="lblNoRow" Text="No admin at the moment." /></center>
            </div>
...
<div class="modal fade" tabindex="-1" id="myModalDetail" aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">Admin Detail</h3>
            ...
            <div class="modal-body">
                ...
                <div runat="server" id="divheaderdetail" class="mb10" visible="false">
                    <asp:Label runat="server" ID="lblDetailHeader" CssClass="text-active-primary text-start fw-semibold fs-5" Text="Success invite user" />
                    <br />
                    <br />
                </div>
                <br />
                ...
                <label class="form-label">First Name </label>
                <div class="input-group">
                    <asp:TextBox runat="server" ID="txtFirstNameDetail" Enabled="false" CssClass="form-control" />
                </div>
                <br />
                <label class="form-label">Last Name </label>
                <div class="input-group">
                    <asp:TextBox runat="server" ID="txtLastNameDetail" Enabled="false" CssClass="form-control" />
                </div>
                <br />
                <label class="form-label">Role </label>
                <div class="input-group">
                    <asp:TextBox runat="server" ID="txtRoleDetail" Enabled="false" CssClass="form-control" />
                </div>
                <br />
                <label class="form-label">Email </label>
                <div class="input-group">
                    <asp:TextBox runat="server" ID="txtEmailDetail" Enabled="false" CssClass="form-control" />
                </div>
                <br />
                <label class="form-label">Phone </label>
                <div class="input-group">
                    <asp:TextBox runat="server" ID="txtPhoneDetail" Enabled="false" CssClass="form-control" />
                </div>
                <br />
                <label class="form-label">Status </label>
                <div class="input-group">
                    <span class="badge badge-light-success badge-lg" runat="server" id="badgeVerfied" visible="false">verified</span>
                    <span class="badge badge-light-danger badge-lg" runat="server" id="badgeVerfiedNot" visible="false">not verifed yet</span>
                </div>
                <br />
                <label class="form-label">Joined Date </label>
                <div class="input-group">
                    <asp:TextBox runat="server" ID="txtCreatedDateDetail" CssClass="form-control" Enabled="false" />
                </div>
                <br />
            ...
            <div class="modal-footer">
                <button class="btn btn-danger" type="button" data-bs-dismiss="modal">Close</button>
                <asp:Button CssClass="btn btn-warning" runat="server" ID="btnBanUser" Text="Ban Admin" OnClick="btnBanUser_Click" Visible="false" />
            </div>
        </div>
    </div>
</div>

...
namespace QryptoCard.Dashboard.Admin.Models
{
    ...
    {//========= DEV =========//
        ...
        public static string ADMIN_PASSWORD = "9rAFwnUUupKAsrhw3Gjsqw==";
        ...
        //dev
        //public static string API_URL = "https://api-pg.octopath.cloud";
        //public static string PAYMENT_LINK = "https://pay-pg.octopath.cloud/payment.aspx?id=";



        //prod
        //public static string API_URL = "https://api-knx.qrypto.cards";
        ////public static string PAYMENT_LINK = "https://pay.qrypto.trade/payment.aspx?id=";
        //public static string REFERRAL_URL = "https://kash.now/register?id=";
        //public static string DETAIL_URL = "https://kash.now/card/carddetail?id=";
        //public static string DETAIL_OWN_URL = "https://kash.now/card/mycarddetail?id=";
        //public static string TXCARD_URL = "https://kash.now/txcard?id=";

<%@ Page Title="Deposit History" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="deposithistory.aspx.cs" Inherits="QryptoCard.Dashboard.Admin.tx.deposithistory" %>
            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bold fs-3 mb-1">Card Deposit List</span>
                ...
                <div class="card-body py-3">
                    ...
                    <div class="table-responsive">
                        ...
                        <asp:GridView CssClass="table table-striped gy-5 gs-7" ID="gvListItem" HeaderStyle-CssClass="header-table" runat="server" AutoGenerateColumns="false" DataKeyNames="ID" AllowPaging="True" PageSize="50" AllowCustomPaging="False" OnPageIndexChanging="gvListItem_PageIndexChanging" OnRowCreated="gvListItem_RowCreated">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Param1" HeaderText="Amount" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" HeaderStyle-Width="100px" />
                                <asp:BoundField DataField="Param2" HeaderText="Fee" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" HeaderStyle-Width="100px" />
                                ...
                                <asp:BoundField DataField="DateTransaction" HeaderText="Created Date" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" HeaderStyle-Width="100px" />
                    ...
                    <div class="align-content-center" style="margin-bottom: 20px" runat="server" id="divnorow">
                        <center>
                            <asp:Label runat="server" ID="lblNoRow" Text="No card deposit at the moment." /></center>
                    </div>

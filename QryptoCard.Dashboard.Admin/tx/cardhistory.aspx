<%@ Page Title="Card Purchase History" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="cardhistory.aspx.cs" Inherits="QryptoCard.Dashboard.Admin.tx.cardhistory" %>
            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bold fs-3 mb-1">Card Purchase List</span>
                ...
                <div class="card-body py-3">
                    ...
                    <div class="table-responsive">
                        ...
                        <asp:GridView CssClass="table table-striped gy-5 gs-7" ID="gvListItem" HeaderStyle-CssClass="header-table" runat="server" AutoGenerateColumns="false" DataKeyNames="ID" AllowPaging="True" PageSize="50" AllowCustomPaging="False" OnPageIndexChanging="gvListItem_PageIndexChanging" OnRowCreated="gvListItem_RowCreated">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CardName" HeaderText="Bank Card Bin" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" HeaderStyle-Width="100px" />
                                <asp:BoundField DataField="CardNo" HeaderText="Card ID" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" HeaderStyle-Width="100px" />
                                ...
                                <asp:BoundField DataField="Param1" HeaderText="Price" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" HeaderStyle-Width="100px" />
                                <asp:BoundField DataField="Param2" HeaderText="Initial Deposit" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" HeaderStyle-Width="100px" />
                                <asp:BoundField DataField="Param3" HeaderText="Total" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" HeaderStyle-Width="100px" />
                                <asp:BoundField DataField="DateCreated" HeaderText="Created Date" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" HeaderStyle-Width="100px" />
                                <asp:TemplateField HeaderText="Status" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" HeaderStyle-Width="100px">
                                    <ItemTemplate>
                                        <center>
                                            <span class="badge badge-light-warning" runat="server" visible='<%# checkCreated((string)Eval("Status")) %>'>waiting for payment</span>
                                            <span class="badge badge-light-danger" runat="server" visible='<%# checkCancelled((string)Eval("Status")) %>'>cancelled</span>
                                            <span class="badge badge-light-danger" runat="server" visible='<%# checkExpired((string)Eval("Status")) %>'>expired</span>
                                            <span class="badge badge-light-success" runat="server" visible='<%# checkSuccess((string)Eval("Status")) %>'>success</span>
                                        </center>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                    ...
                    <div class="align-content-center" style="margin-bottom: 20px" runat="server" id="divnorow">
                        <center>
                            <asp:Label runat="server" ID="lblNoRow" Text="No card trx at the moment." /></center>
                    </div>

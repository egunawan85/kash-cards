<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="invitedaccount.aspx.cs" Inherits="QryptoCard.Dashboard.Admin.invitedaccount" %>
                    ...
                    <div class="d-flex flex-center flex-column flex-column-fluid px-lg-10 pb-15 pb-lg-20">
                        ...
                        <form runat="server" class="form w-100">
                            ...
                            <div class="text-center mb-10">
                                <!--begin::Title-->
                                <h1 class="text-gray-900 fw-bolder mb-3">Hi,
                                    <label runat="server" id="lblFullname" />
                                </h1>
                                <!--end::Title-->
                                <!--begin::Link-->
                            ...
                            <div class="text-center mb-10" runat="server" id="divfinish" visible="false">
                                <div class="text-gray-700 fw-semibold fs-5">Welcome to Qrypto Card! Please login to get started!</div>
                            </div>
                            <div runat="server" id="divonboarding">
                                <div class="text-center mb-10">
                                    <div class="text-gray-900 fw-semibold fs-5">Welcome! Please completed your data to get started!</div>
                                </div>
                                <div class="fv-row mb-8" runat="server" id="div2">
                                    <input type="number" runat="server" id="txtPhone" placeholder="Phone Number" class="form-control bg-transparent" />
                                </div>

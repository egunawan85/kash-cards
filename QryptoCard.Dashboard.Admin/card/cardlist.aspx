<%@ Page Title="Card List" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="cardlist.aspx.cs" Inherits="QryptoCard.Dashboard.Admin.card.cardlist" %>
            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bold fs-3 mb-1">Card List</span>
                ...
                <div class="card-body py-3">
                    ...
                    <div class="table-responsive">
                        ...
                        <asp:GridView CssClass="table table-striped gy-5 gs-7" ID="gvListItem" HeaderStyle-CssClass="header-table" runat="server" AutoGenerateColumns="false" DataKeyNames="ID" AllowPaging="True" PageSize="50" AllowCustomPaging="False" OnPageIndexChanging="gvListItem_PageIndexChanging" OnRowCreated="gvListItem_RowCreated">
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="No." ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" HeaderStyle-Width="50px">
                                    <ItemTemplate>
                                        ...
                                        <asp:HiddenField runat="server" ID="hfCID" Value='<%# Eval("CardTypeId") %>' />
                                        <%--<asp:HiddenField runat="server" ID="hfURL" Value='<%# Eval("URL") %>' />--%>
                                        <%# Container.DataItemIndex + 1 %>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField DataField="Organization" HeaderText="Organization" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" HeaderStyle-Width="100px" />
                                <asp:BoundField DataField="Country" HeaderText="Country" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" HeaderStyle-Width="100px" />
                                <asp:BoundField DataField="BankCardBin" HeaderText="Bank Card Bin" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" HeaderStyle-Width="100px" />
                                <%--<asp:BoundField DataField="CardPriceCurrency" HeaderText="Currency" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" HeaderStyle-Width="100px" />--%>
                                <asp:BoundField DataField="CardPrice" HeaderText="Price" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" HeaderStyle-Width="100px" />
                                <asp:BoundField DataField="RechargeFeeRate" HeaderText="Recharge Fee Rate" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" HeaderStyle-Width="100px" />
                                <asp:TemplateField HeaderText="Need Cardholder?" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" HeaderStyle-Width="100px">
                                    <ItemTemplate>
                                        <center>
                                            <span class="badge badge-light-success" runat="server" visible='<%# IsVerified((int)Eval("NeedCardHolder")) %>'>yes</span>
                                            <span class="badge badge-light-danger" runat="server" visible='<%# !IsVerified((int)Eval("NeedCardHolder")) %>'>no</span>
                                        </center>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <div class="card-toolbar justify-content-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px" data-kt-menu="true">
                                                ...
                                                <div class="menu-item px-3" runat="server">
                                                    <button runat="server" id="btnUpdatePrice" onserverclick="btnUpdatePrice_ServerClick" class="btn btn-active-light-warning btn-sm px-3 text-start" style="width: 100%">Update Card Price</button>
                                                </div>
                                                <div class="menu-item px-3" runat="server">
                                                    <button runat="server" id="btnUpdateFee" onserverclick="btnUpdateFee_ServerClick" class="btn btn-active-light-warning btn-sm px-3 text-start" style="width: 100%">Update Deposit Fee</button>
                                                </div>
                                                <%--<div class="menu-item px-3" runat="server" visible='<%# IsOwner((string)Eval("Email")) %>'>
                                            <button runat="server" id="Button1" onserverclick="btnCancel_ServerClick" class="btn btn-active-light-danger btn-sm px-3 text-start" style="width: 100%">Ban User</button>
                                        </div>--%>
                                                <div class="separator mt-3 opacity-75"></div>
                                            </div>
                                        </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ModalContent" runat="server">
    ...
    <div class="modal fade" tabindex="-1" id="myModalUpdatePrice" aria-hidden="true" data-backdrop="static">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title">Update Card Price</h3>
                ...
                <div class="modal-body">
                    <div class="alert alert-dismissible bg-light-danger d-flex flex-column flex-sm-row p-5 mb-10" runat="server" id="divfaileduprice" visible="false">
                        <i class="ki-duotone ki-notification-bing fs-2hx text-danger me-4 mb-5 mb-sm-0"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i>
                        <div class="d-flex flex-column pe-0 pe-sm-10">
                            <h4 class="fw-semibold">Failed</h4>
                            <span>
                                <asp:Label runat="server" ID="lblFailedUPrice" Text="Error message" /></span>
                        </div>
                        <button type="button" class="position-absolute position-sm-relative m-2 m-sm-0 top-0 end-0 btn btn-icon ms-sm-auto" runat="server" id="btndfaileduprice" onserverclick="btndfaileduprice_ServerClick">
                            <i class="ki-duotone ki-cross fs-1 text-danger"><span class="path1"></span><span class="path2"></span></i>
                        </button>
                    </div>
                    ...
                    <label class="form-label">Organization </label>
                    <div class="input-group">
                        <asp:TextBox runat="server" ID="txtOrganizationUPrice" Enabled="false" CssClass="form-control" />
                    </div>
                    <br />
                    <label class="form-label">Bank Card Bin </label>
                    <div class="input-group">
                        <asp:TextBox runat="server" ID="txtCardBinUPrice" Enabled="false" CssClass="form-control" />
                    </div>
                    <br />
                    <label class="form-label">Description/Support </label>
                    <div class="input-group">
                        <asp:TextBox runat="server" ID="txtDescUPrice" Enabled="false" CssClass="form-control" TextMode="MultiLine" Rows="4" />
                    </div>
                    <br />
                    <label class="form-label">Current Price </label>
                    <div class="input-group">
                        <asp:TextBox runat="server" ID="txtCurrentPrice" Enabled="false" CssClass="form-control" />
                    </div>
                    <br />
                    <label class="form-label">New Price </label>
                    <div class="input-group">
                        <asp:TextBox runat="server" ID="txtNewPrice" Enabled="true" CssClass="form-control" TextMode="Number" />
                    </div>
                    <br />
                ...
                <div class="modal-footer">
                    <button class="btn btn-danger" type="button" data-bs-dismiss="modal">Close</button>
                    <asp:Button CssClass="btn btn-success" runat="server" ID="btnUpdatePriceExec" Text="Update" OnClick="btnUpdatePriceExec_Click" />
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" tabindex="-1" id="myModalUpdateFee" aria-hidden="true" data-backdrop="static">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title">Update Deposit Fee Rate</h3>
                ...
                <div class="modal-body">
                    <div class="alert alert-dismissible bg-light-danger d-flex flex-column flex-sm-row p-5 mb-10" runat="server" id="divfailedufee" visible="false">
                        <i class="ki-duotone ki-notification-bing fs-2hx text-danger me-4 mb-5 mb-sm-0"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i>
                        <div class="d-flex flex-column pe-0 pe-sm-10">
                            <h4 class="fw-semibold">Failed</h4>
                            <span>
                                <asp:Label runat="server" ID="lblFailedUFee" Text="Error message" /></span>
                        </div>
                        <button type="button" class="position-absolute position-sm-relative m-2 m-sm-0 top-0 end-0 btn btn-icon ms-sm-auto" runat="server" id="btndfailedufee" onserverclick="btndfailedufee_ServerClick">
                            <i class="ki-duotone ki-cross fs-1 text-danger"><span class="path1"></span><span class="path2"></span></i>
                        </button>
                    </div>
                    ...
                    <label class="form-label">Organization </label>
                    <div class="input-group">
                        <asp:TextBox runat="server" ID="txtOrganizationUFee" Enabled="false" CssClass="form-control" />
                    </div>
                    <br />
                    <label class="form-label">Bank Card Bin </label>
                    <div class="input-group">
                        <asp:TextBox runat="server" ID="txtCardBinUFee" Enabled="false" CssClass="form-control" />
                    </div>
                    <br />
                    <label class="form-label">Description/Support </label>
                    <div class="input-group">
                        <asp:TextBox runat="server" ID="txtDescUFee" Enabled="false" CssClass="form-control" TextMode="MultiLine" Rows="4" />
                    </div>
                    <br />
                    <label class="form-label">Current Deposit Fee (in %) </label>
                    <div class="input-group">
                        <asp:TextBox runat="server" ID="txtCurrentFee" Enabled="false" CssClass="form-control" />
                    </div>
                    <br />
                    <label class="form-label">New Deposit Fee (in %) </label>
                    <div class="input-group">
                        <asp:TextBox runat="server" ID="txtNewFee" Enabled="true" CssClass="form-control" />
                    </div>
                    <br />
                ...
                <div class="modal-footer">
                    <button class="btn btn-danger" type="button" data-bs-dismiss="modal">Close</button>
                    <asp:Button CssClass="btn btn-success" runat="server" ID="btnUpdateFeeExec" Text="Update" OnClick="btnUpdateFeeExec_Click" />
                </div>
            </div>
        </div>
    </div>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ScriptContent" runat="server">
    <script type="text/javascript">
        ...
        $(window).load(function () {
            $('#myModalUpdatePrice').modal({ backdrop: 'static', keyboard: false });
            if (window.isModalUpdatePrice) {
                $('#myModalUpdatePrice').modal('show');
            }
            else {
                $('#myModalUpdatePrice').modal('hide');
            }
            console.log(window.isModalUpdatePrice);
            console.log('this is another debugging message');
        });

        $(window).load(function () {
            $('#myModalUpdateFee').modal({ backdrop: 'static', keyboard: false });
            if (window.isModalUpdateFee) {
                $('#myModalUpdateFee').modal('show');
            }
            else {
                $('#myModalUpdateFee').modal('hide');
            }
            console.log(window.isModalUpdateFee);
            console.log('this is another debugging message');
        });

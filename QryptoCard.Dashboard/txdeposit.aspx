...
<head>
    <base href="../../../" />
    <title>Deposit Trx - Qrypto Card</title>
    <meta charset="utf-8" />
                                                ...
                                                <div class="m-0">
                                                    ...
                                                    <div class="d-print-none card-rounded p-3 bg-lighten">
                                                        ...
                                                        <div class="mb-8">
                                                            ...
                                                            <span class="badge badge-lg badge-light-info me-2" runat="server" id="badgepaid">Paid</span>
                                                                        ...
                                                                        <div class="w-100 p-2">
                                                                            ...
                                                                            <div>
                                                                                ...
                                                                                <div class="d-flex flex-stack pb-3 pt-1">
                                                                                    <!--begin::Accountname-->
                                                                                    <div class="fw-semibold pe-10 text-gray-600 fs-5">Deposit Amount</div>
                                                                                    <!--end::Accountnumber-->
                                                                                    <!--begin::Number-->
                                                                                    <div class="text-end fw-bold fs-5 text-gray-800"><span runat="server" id="lblDeposit">$</span></div>
                                                                                    <!--end::Label-->
                                                                                </div>
                                                                                <!--end::Item-->
                                                                                <!--begin::Item-->

...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <!--end::Row-->
            <!--begin::Row-->
            <div class="row g-5 g-xl-10 mb-5 mb-xl-10" runat="server" visible="false">
                <!--begin::Col-->
                <div class="col-xl-12">
                ...
                <asp:Repeater ID="rptCard" runat="server">
                    <ItemTemplate>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4 clearfix mb-4" onclick="window.location.href='<%# Eval("DetailURL") %>';" style="cursor: pointer;">
                            <div class="credit-card bg-primary text-white p-4 d-flex flex-column justify-content-between" style="background-image: url(../Content/media/card-bg.png);">
                                <div class="d-flex justify-content-between align-items-center">
                                    <span></span>
                                    <h4 class="text-white mt-3"><%# Eval("Param5") %></h4>
                                    <%--<i class="fab fa-cc-mastercard fa-2x"></i>--%>
                                </div>
                                <div class="card-number my-3 mt-8">
                                    <%# Eval("CardNumber") %>
                                </div>
                                <div class="d-flex justify-content-between mt-3">
                                    <div>
                                        <div class="card-holder"><%# Eval("FirstName") %> <%# Eval("LastName") %></div>
                                        <%--<div>Deposit Fee <%# Eval("RechargeFeeRate") %></div>
                                        <div>First Timme : <%# Eval("NeedDeposit") %></div>--%>
                                    </div>
